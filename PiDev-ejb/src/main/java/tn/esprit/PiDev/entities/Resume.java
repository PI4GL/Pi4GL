...
public class Resume implements Serializable{
	...
	public Resume(int resumeId, String description, String note, List<Competence> Competences, Ressource owner) {
		super();
	...
	public void setSkills(List<Competence> _Skills) {
		this.Competences = _Skills;
	}
